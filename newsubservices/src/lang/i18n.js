...
export async function loadLocaleMessages(i18nOrComposer, locale, options = {}) {
  ...
  if (includeCommonMessages) {
    try {
      ...
      console.warn(`[newsubservices i18n] load common messages failed: ${normalizedLocale}`, error)
    }
  }
  ...
  if (includeRouteMessages) {
    try {
      ...
      console.warn(`[newsubservices i18n] load route messages failed: ${normalizedLocale}`, error)
    }
  }
...
export async function loadPageLocaleMessages(i18nOrComposer, locale, pageCode) {
  ...
  try {
    ...
    console.warn(`[newsubservices i18n] load page messages failed: ${normalizedLocale}/${normalizedPageCode}`, error)
  }
}
