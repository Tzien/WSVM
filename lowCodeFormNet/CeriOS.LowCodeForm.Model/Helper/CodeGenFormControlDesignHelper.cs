...
public class CodeGenFormControlDesignHelper
{
    ...
    public static List<FormControlDesignModel> FormControlDesign(List<FieldsModel> fieldList, List<FieldsModel> realisticControls, FormDataModel formDataModel, List<IndexGridFieldModel> columnDesignModel, int dataType, int logic, int vueVersion, bool isMain = false)
    {
        ...
        foreach (var item in JsonConvert.DeserializeObject<List<FieldsModel>>(JsonConvert.SerializeObject(fieldList)))
        {
            var config = item.__config__;

            // 控件标题 + 后缀
            if (formDataModel.labelSuffix.IsNotEmptyOrNull() && config != null && config.label != null && !config.ceriKey.Equals(CeriKeyConst.TABLE) && (config.parentVModel == null || !config.parentVModel.Contains("tableField")))
            {
            ...
            var needTemplateJson = new List<string>() { CeriKeyConst.POPUPTABLESELECT, CeriKeyConst.POPUPSELECT, CeriKeyConst.AUTOCOMPLETE };
            var specialDateAttribute = new List<string>() { CeriKeyConst.DATE, CeriKeyConst.TIME };
            switch (config.ceriKey)
            {
                case CeriKeyConst.ROW:
                    {
                ...
                case CeriKeyConst.TABLE:
                    {
                        ...
                        var childrenRealisticControls = realisticControls.Find(it => it.__vModel__.Equals(item.__vModel__) && it.__config__.ceriKey.Equals(CeriKeyConst.TABLE)).__config__.children;
                        ...
                        {
                            if (logic == 5 && children.__config__.ceriKey.Equals(CeriKeyConst.CALCULATE)) continue;
                            var childrenConfig = children.__config__;
                            switch (childrenConfig.ceriKey)
                            {
                                ...
                                case CeriKeyConst.POPUPATTR:
                                    {
                                        ...
                                        childrenTableList.Add(new FormControlDesignModel()
                                        {
                                            ...
                                            Style = children.style != null && !children.style.ToString().Equals("{}") ? $":style='{JsonConvert.SerializeObject(children.style)}' " : string.Empty,
                                            ceriKey = childrenConfig.ceriKey,
                                ...
                                default:
                                    {
                                        ...
                                        if (childrenConfig.ceriKey.Equals(CeriKeyConst.SIGNATURE)) ableIds = children.ableIds.IsNotEmptyOrNull() ? string.Format(":ableIds='{0}' ", JsonConvert.SerializeObject(children.ableIds)) : string.Empty;
                                        ...
                                        var realisticControl = childrenRealisticControls.Find(it => it.__vModel__.Equals(children.__vModel__) && it.__config__.ceriKey.Equals(childrenConfig.ceriKey));
                                        if (childrenConfig.ceriKey.Equals(CeriKeyConst.POPUPSELECT)) children.modelId = children.interfaceId;
                                        childrenTableList.Add(new FormControlDesignModel()
                                        {
                                            ceriKey = childrenConfig.ceriKey,
                                            ...
                                            AutoSize = children.autoSize != null ? $":autosize='{JsonConvert.SerializeObject(children.autoSize)}' " : string.Empty,
                                            Multiple = (childrenConfig.ceriKey.Equals(CeriKeyConst.CASCADER) ? children.multiple : children.multiple) ? $"multiple " : string.Empty,
                                            ...
                                            MaskConfig = children.maskConfig != null ? $":maskConfig='{JsonConvert.SerializeObject(children.maskConfig)}' " : string.Empty,
                                            ...
                                            PickerOptions = children.pickeroptions != null && JsonConvert.SerializeObject(children.pickeroptions) != "null" ? $":picker-options='{JsonConvert.SerializeObject(children.pickeroptions)}' " : string.Empty,
                                            ...
                                            TemplateJson = needTemplateJson.Contains(childrenConfig.ceriKey) ? string.Format(":templateJson='{0}_{1}TemplateJson' ", item.__vModel__, children.__vModel__) : string.Empty,
                                            ...
                                            IsSwitch = childrenConfig.ceriKey == CeriKeyConst.SWITCH ? $":active-value='{children.activeValue}' :inactive-value='{children.inactiveValue}' " : string.Empty,
                                            ...
                                            Level = childrenConfig.ceriKey == CeriKeyConst.ADDRESS ? $":level='{children.level}' " : string.Empty,
                                            ...
                                            Field = !item.layoutType.Equals("list") && (childrenConfig.ceriKey.Equals(CeriKeyConst.RELATIONFORM) || childrenConfig.ceriKey.Equals(CeriKeyConst.POPUPSELECT)) ? $":field=\"'{children.__vModel__}'+scope.$index\" " : string.Empty,
                                            required = childrenConfig.required,
                                            ...
                                            IsRelationForm = childrenConfig.ceriKey.Equals(CeriKeyConst.RELATIONFORM),
                                            ...
                                            StartTime = specialDateAttribute.Contains(childrenConfig.ceriKey) ? SpecialTimeAttributeAssembly(children, realisticControls, 1, false) : string.Empty,
                                            EndTime = specialDateAttribute.Contains(childrenConfig.ceriKey) ? SpecialTimeAttributeAssembly(children, realisticControls, 2, false) : string.Empty,
                                            ...
                                            LocationScope = string.Format(":locationScope='{0}' ", children.locationScope.IsNotEmptyOrNull() ? JsonConvert.SerializeObject(children.locationScope) : "[]"),
                                            ShowCount = childrenConfig.ceriKey.Equals(CeriKeyConst.COMINPUT) || childrenConfig.ceriKey.Equals(CeriKeyConst.TEXTAREA) ? string.Format(" :showCount='{0}' ", children.showCount.ToString().ToLower()) : string.Empty,
                                            Disaabled = childrenConfig.ceriKey.Equals(CeriKeyConst.SIGNATURE) ? string.Format(" :disaabled=\"{0}\" ", children.disaabled.ToString().ToLower()) : string.Empty,
                                            IsInvoke = childrenConfig.ceriKey.Equals(CeriKeyConst.SIGN) ? string.Format(" :isInvoke='{0}' ", children.isInvoke.ToString().ToLower()) : string.Empty,
                                            SortRule = children.sortRule.IsNotEmptyOrNull() ? string.Format(" :sortRule='{0}'", JsonConvert.SerializeObject(children.sortRule)) : string.Empty,
                                ...
                                foreach (var childItem in config.children)
                                {
                                    if (childItem.__config__.tableFixed.Equals("none") && item.__config__.complexHeaderList.Any(x => x.childColumns.Any(xx => xx.Equals(childItem.__vModel__))))
                                    {
                                        ...
                                        if (!complexList.Any(x => x.Name.Equals(complexPItem.id)))
                                        {
                                            ...
                                            addItem.ceriKey = string.Empty;
                                            complexPItem.childColumns.Where(x => !tfVModelList.Contains(x)).ToList().ForEach(it =>
                                            {
                                                var cItem = childrenTableList.Find(x => x.Name.Equals(it) && x.ceriKey != CeriKeyConst.POPUPATTR && x.ceriKey != CeriKeyConst.RELATIONFORMATTR);
                                    ...
                                    else
                                    {
                                        ...
                                        if (childItem.__config__.ceriKey.Equals(CeriKeyConst.POPUPATTR) || childItem.__config__.ceriKey.Equals(CeriKeyConst.RELATIONFORMATTR))
                                        {
                        ...
                        item.footerBtnsList.Where(x => x.show).ToList().ForEach(x =>
                        {
                            ...
                            x.actionConfig = JsonConvert.SerializeObject(x.actionConfig) + ",";
                        });
                        list.Add(new FormControlDesignModel()
                        {
                            ceriKey = config.ceriKey,
                            ...
                            SummaryField = JsonConvert.SerializeObject(item.summaryField),
                            SummaryFieldLabelWidth = JsonConvert.SerializeObject(summaryFieldLabelWidth),
                            IsSummary = item.showSummary,
                            SummaryListStr = JsonConvert.SerializeObject(childrenTableList.Where(x => x.IsSummary).Select(x => x.Name).ToList()),
                        });
                    }

                    break;
                case CeriKeyConst.CARD:
                    {
                        List<FormControlDesignModel> childrenCollapseList = FormControlDesign(config.children, realisticControls, formDataModel, columnDesignModel, dataType, logic, 2);
                        list.Add(new FormControlDesignModel()
                        {
                ...
                case CeriKeyConst.COLLAPSE:
                    {
                        ...
                        list.Add(new FormControlDesignModel()
                        {
                            ...
                            Name = activeKey,
                            Active = JsonConvert.SerializeObject(childrenCollapseList.Select(it => it.Name)),
                            Children = childrenCollapseList,
                            Span = config.span,
                            LabelWidth = config?.labelWidth ?? formDataModel.labelWidth,
                            IsRelationForm = childrenCollapseList.Any(x => x.IsRelationForm)
                    ...
                    break;
                case CeriKeyConst.TAB:
                case CeriKeyConst.STEPS:
                    {
                        // 先加为了防止 children下 还有折叠面板
                        List<FormControlDesignModel> childrenCollapseList = new List<FormControlDesignModel>();
                        foreach (var children in config.children)
                        {
                            ...
                            if (logic == 5 && config.ceriKey.Equals(CeriKeyConst.TAB)) title = children.titleI18nCode.IsNotEmptyOrNull() ? $":tab=\"t('{children.titleI18nCode}', '{children.title}')\" " : (children.title.IsNotEmptyOrNull() ? $"tab='{children.title}' " : string.Empty);
                            childrenCollapseList.Add(new FormControlDesignModel()
                            {
                                Title = title,
                                Name = children.name,
                ...
                case CeriKeyConst.CERITEXT:
                    {
                        list.Add(new FormControlDesignModel()
                        {
                            ...
                            Content = logic == 5 && item.contentI18nCode.IsNotEmptyOrNull() ? $":content=\"$t('{item.contentI18nCode}', '{item.content}')\" " : (item.content.IsNotEmptyOrNull() ? $"content='{item.content}' " : string.Empty),
                            TextStyle = item.textStyle != null ? JsonConvert.SerializeObject(item.textStyle) : string.Empty,
                            LabelWidth = config?.labelWidth ?? formDataModel.labelWidth,
                        });
                    }

                    break;
                case CeriKeyConst.BUTTON:
                    {
                        list.Add(new FormControlDesignModel()
                        {
                            Tag = config.tag,
                ...
                case CeriKeyConst.ALERT:
                    ...
                    break;
                case CeriKeyConst.QRCODE:
                case CeriKeyConst.BARCODE:
                    {
                ...
                case CeriKeyConst.POPUPATTR:
                    {
                        ...
                        list.Add(new FormControlDesignModel()
                        {
                            ...
                            Style = item.style != null && !item.style.ToString().Equals("{}") ? $":style='{JsonConvert.SerializeObject(item.style)}' " : string.Empty,
                            ceriKey = config.ceriKey,
                ...
                default:
                    {
                        if (config.ceriKey.Equals(CeriKeyConst.CALCULATE)) break;
                        var realisticControl = realisticControls.Find(it => it.__vModel__.Equals(item.__vModel__) && it.__config__.ceriKey.Equals(config.ceriKey));
                        var columnDesign = columnDesignModel?.Find(it => it.__vModel__ == item.__vModel__);
                        string vModel = string.Empty;
                        var Model = item.__vModel__;
                        vModel = dataType != 4 ? $"v-model='dataForm.{Model}' " : $"v-model='scope.row.{Model}' ";
                        var ableIds = string.Empty;
                        if (config.ceriKey.Equals(CeriKeyConst.SIGNATURE)) ableIds = item.ableIds.IsNotEmptyOrNull() ? string.Format(":ableIds='{0}' ", JsonConvert.SerializeObject(item.ableIds)) : string.Empty;
                        else ableIds = item.selectType != null && item.selectType == "custom" ? string.Format(":ableIds='{0}_AbleIds' ", item.__vModel__) : string.Empty;
                        if (config.ceriKey.Equals(CeriKeyConst.POPUPSELECT)) item.modelId = item.interfaceId;
                        list.Add(new FormControlDesignModel()
                        {
                            ...
                            AutoSize = item.autoSize != null && JsonConvert.SerializeObject(item.autoSize) != "null" ? $":autosize='{JsonConvert.SerializeObject(item.autoSize)}' " : string.Empty,
                            Multiple = (config.ceriKey.Equals(CeriKeyConst.CASCADER) ? item.multiple : item.multiple) ? $"multiple " : string.Empty,
                            ...
                            PickerOptions = item.pickeroptions != null && JsonConvert.SerializeObject(item.pickeroptions) != "null" ? $":picker-options='{JsonConvert.SerializeObject(item.pickeroptions)}' " : string.Empty,
                            ...
                            IsSwitch = config.ceriKey == CeriKeyConst.SWITCH ? $":active-value='{item.activeValue}' :inactive-value='{item.inactiveValue}' " : string.Empty,
                            ...
                            ButtonText = logic == 5 && item.buttonTextI18nCode.IsNotEmptyOrNull() ? $":buttonText=\"$t('{item.buttonTextI18nCode}', '{item.buttonText}')\" " : (item.buttonText.IsNotEmptyOrNull() ? $"buttonText='{item.buttonText}' " : string.Empty),
                            Level = config.ceriKey == CeriKeyConst.ADDRESS ? $":level='{item.level}' " : string.Empty,
                            ...
                            TemplateJson = needTemplateJson.Contains(config.ceriKey) ? string.Format(":templateJson='{0}TemplateJson' ", item.__vModel__) : string.Empty,
                            ...
                            Field = config.ceriKey.Equals(CeriKeyConst.RELATIONFORM) || config.ceriKey.Equals(CeriKeyConst.POPUPSELECT) ? $"field='{item.__vModel__}' " : string.Empty,
                            ...
                            IsLinked = realisticControl.IsLinked,
                            IsLinkage = realisticControl.IsLinkage,
                            IsRelationForm = config.ceriKey.Equals(CeriKeyConst.RELATIONFORM),
                            ...
                            StartTime = specialDateAttribute.Contains(config.ceriKey) ? SpecialTimeAttributeAssembly(item, fieldList, 1, true) : string.Empty,
                            EndTime = specialDateAttribute.Contains(config.ceriKey) ? SpecialTimeAttributeAssembly(item, fieldList, 2, true) : string.Empty,
                            ShowLabel = config.showLabel,
                            Align = config.tableAlgin,
                            TableFixed = config.tableFixed,
                            ...
                            LocationScope = string.Format(":locationScope='{0}' ", item.locationScope.IsNotEmptyOrNull() ? JsonConvert.SerializeObject(item.locationScope) : "[]"),
                            ShowCount = config.ceriKey.Equals(CeriKeyConst.COMINPUT) || config.ceriKey.Equals(CeriKeyConst.TEXTAREA) ? string.Format(" :showCount='{0}' ", item.showCount.ToString().ToLower()) : string.Empty,
                            Disaabled = config.ceriKey.Equals(CeriKeyConst.SIGNATURE) ? string.Format(" :disaabled=\"{0}\" ", item.disaabled.ToString().ToLower()) : string.Empty,
                            IsInvoke = config.ceriKey.Equals(CeriKeyConst.SIGN) ? string.Format(" :isInvoke='{0}' ", item.isInvoke.ToString().ToLower()) : string.Empty,
                            SortRule = item.sortRule.IsNotEmptyOrNull() ? string.Format(" :sortRule='{0}'", JsonConvert.SerializeObject(item.sortRule)) : string.Empty,
                            ...
                            ExtraOptions = item.extraOptions != null ? string.Format(":extraOptions='{0}'", JsonConvert.SerializeObject(item.extraOptions)) : string.Empty,
                            ExtraOption = new CodeGenFrontEndFormState() { Name = item.__vModel__, Value = JsonConvert.SerializeObject(item.extraOptions) },
                            InterfaceRes = new CodeGenFrontEndFormState() { Name = item.__vModel__, Value = JsonConvert.SerializeObject(item.templateJson) },
    ...
    public static CodeGenFrontEndFormScriptModel FormScriptDesign(List<FieldsModel> fieldList, List<FieldsModel> realisticControls, string subTableName, FormDataModel formDataModel, List<IndexGridFieldModel> columnDesignModel, int dataType, int logic, bool hasFlow, bool isMain = false)
    {
        ...
        foreach (var item in fieldList)
        {
                ...
                case CeriKeyConst.COLLAPSE:
                    {
                        ...
                        {
                            Name = activeKey,
                            Value = JsonConvert.SerializeObject(childrenCollapseList.Select(it => it.Name)),
                        });
                    }
                ...
                case CeriKeyConst.STEPS:
                    {
                        ...
                        foreach (var children in config.children)
                        {
                            ...
                            if (config.ceriKey.Equals(CeriKeyConst.TAB)) title = logic.Equals(4) && children.titleI18nCode.IsNotEmptyOrNull() ? $":tab=\"t('{children.titleI18nCode}', '{children.title}')\" " : (children.title.IsNotEmptyOrNull() ? $"tab='{children.title}' " : string.Empty);
                            childrenCollapseList.Add(new FormControlDesignModel()
                            {
                                Title = title,
                                Name = children.name,
                        ...
                        {
                            Name = activeKey,
                            Value = JsonConvert.SerializeObject(config.active),
                        });
                    }
                ...
                case CeriKeyConst.TABLE:
                    {
                        ...
                        subTableDesign.Add(new CodeGenFrontEndSubTableDesignModel
                        {
                            ...
                            ComplexColumns = item.__config__.complexHeaderList != null && item.__config__.complexHeaderList.Any() ? JsonConvert.SerializeObject(item.__config__.complexHeaderList).Replace("\"t('", "t('").Replace("')\",", "'),") : "[]",
                            ColumnBtnsList = item.columnBtnsList.Where(x => x.show).ToList(),
                            FooterBtnsList = item.footerBtnsList.Where(x => x.show).ToList(),
                            IsAnyBatchRemove = item.footerBtnsList.Any(x => x.show && x.value.Equals("batchRemove")),
            ...
            var attrControls = new List<string>() {
                CeriKeyConst.POPUPATTR,
                CeriKeyConst.RELATIONFORMATTR
            };

            bool isShow = false;

            // 当前循环 是否属性控件组
            if (attrControls.Contains(config.ceriKey))
            {
            ...
            if (true)
            {
                ...
                {
                    CeriKeyConst.POPUPSELECT,
                    CeriKeyConst.POPUPTABLESELECT,
                    CeriKeyConst.AUTOCOMPLETE,
                    CeriKeyConst.RELATIONFORM
                };

                // 寻找主副表联动子表内的控件绑定__vModel__
                if (!isSubTable && (realisticControl?.linkageReverseRelationship.Any(it => it.isChildren && !ignoreChangeEventList.Contains(it.ceriKey))).ParseToBool() && !mainLinkageSubTable.Any(it => it.Name.Equals(subTableName) && it.Value.Equals(item.__vModel__)))
                {
                    List<CodeGenFrontEndFormState> state = new List<CodeGenFrontEndFormState>();
                    foreach (var mainConsonant in realisticControl.linkageReverseRelationship.FindAll(it => it.isChildren && !ignoreChangeEventList.Contains(it.ceriKey)).ToList())
                    {
                ...
                switch (config.ceriKey)
                {
                    case CeriKeyConst.COMINPUT:
                    case CeriKeyConst.TEXTAREA:
                    case CeriKeyConst.NUMINPUT:
                    ...
                    case CeriKeyConst.SWITCH:
                    case CeriKeyConst.TIME:
                    case CeriKeyConst.UPLOADFZ:
                    case CeriKeyConst.UPLOADIMG:
                    case CeriKeyConst.COLORPICKER:
                    case CeriKeyConst.RATE:
                    case CeriKeyConst.SLIDER:
                    case CeriKeyConst.EDITOR:
                    ...
                    case CeriKeyConst.SIGN:
                    case CeriKeyConst.SIGNATURE:
                    case CeriKeyConst.LOCATION:
                        {
                            ...
                            //};
                            formControlDesignModel = new FormControlDesignModel();
                            formControlDesignModel.ceriKey = config.ceriKey;
                            formControlDesignModel.Span = config.span;
                            formControlDesignModel.Name = item.__vModel__;
                            formControlDesignModel.Label = configLabel;
                            formControlDesignModel.ShowLabel = config.showLabel;
                            formControlDesignModel.TipLabel = logic.Equals(4) && config.showLabel && config.tipLabelI18nCode.IsNotEmptyOrNull() ? $"<BasicHelp :text=\"t('{config.tipLabelI18nCode}', '{config.tipLabel}')\"/> " : (config.tipLabel.IsNotEmptyOrNull() ? $"<BasicHelp text='{config.tipLabel}'/> " : string.Empty);
                            formControlDesignModel.Tag = config.tag;
                            formControlDesignModel.vModel = vModel;
                            formControlDesignModel.OldVModel = item.__vModel__;
                            formControlDesignModel.LabelWidth = config?.labelWidth ?? formDataModel.labelWidth;
                            formControlDesignModel.Style = !string.IsNullOrEmpty(item.style?.ToString()) ? string.Format(":style='{0}' ", JsonConvert.SerializeObject(item.style)) : string.Empty;
                            formControlDesignModel.Disabled = item.disabled ? string.Format("disabled ") : string.Empty;
                            formControlDesignModel.Hidden = config.noShow ? string.Format("v-show=\"false\" ") : string.Empty;
                            formControlDesignModel.IsLinked = realisticControl.IsLinked;
                            formControlDesignModel.IsLinkage = realisticControl.IsLinkage;
                            ...
                            formControlDesignModel.LocationScope = string.Format(":locationScope='{0}' ", item.locationScope.IsNotEmptyOrNull() ? JsonConvert.SerializeObject(item.locationScope) : "[]");
                            formControlDesignModel.ShowCount = config.ceriKey.Equals(CeriKeyConst.COMINPUT) || config.ceriKey.Equals(CeriKeyConst.TEXTAREA) ? string.Format(" :showCount='{0}' ", item.showCount.ToString().ToLower()) : string.Empty;
                            formControlDesignModel.Disaabled = config.ceriKey.Equals(CeriKeyConst.SIGNATURE) ? string.Format(" :disaabled=\"{0}\" ", item.disaabled.ToString().ToLower()) : string.Empty;
                            formControlDesignModel.IsInvoke = config.ceriKey.Equals(CeriKeyConst.SIGN) ? string.Format(" :isInvoke='{0}' ", item.isInvoke.ToString().ToLower()) : string.Empty;
                            formControlDesignModel.AbleIds = item.ableIds.IsNotEmptyOrNull() ? string.Format(" :ableIds='{0}' ", JsonConvert.SerializeObject(item.ableIds)) : string.Empty;
                            formControlDesignModel.SortRule = item.sortRule.IsNotEmptyOrNull() ? string.Format(" :sortRule='{0}'", JsonConvert.SerializeObject(item.sortRule)) : string.Empty;
                            formControlDesignModel.TimeFormat = item.timeFormat.IsNotEmptyOrNull() ? string.Format(" timeFormat='{0}'", item.timeFormat) : string.Empty;
                            formControlDesignModel.required = item.__config__.required;
                            ...
                            // 如果联动配置内
                            if (!realisticControl.linkageReverseRelationship.Any(it => !ignoreChangeEventList.Contains(it.ceriKey)))
                            ...
                            switch (isSubTable)
                            {
                                case true:
                                    ...
                                    var isSystemControl = item.__config__.ceriKey.Equals(CeriKeyConst.BILLRULE) || item.__config__.ceriKey.Equals(CeriKeyConst.MODIFYUSER)
                                        || item.__config__.ceriKey.Equals(CeriKeyConst.CREATEUSER) || item.__config__.ceriKey.Equals(CeriKeyConst.MODIFYTIME) || item.__config__.ceriKey.Equals(CeriKeyConst.CREATETIME)
                                        || item.__config__.ceriKey.Equals(CeriKeyConst.CURRPOSITION) || item.__config__.ceriKey.Equals(CeriKeyConst.CURRORGANIZE);
                            ...
                            switch (item.isStorage)
                            {
                                case 0:
                                    formControlDesignModel = new FormControlDesignModel()
                                    {
                                        ...
                                        TipLabel = logic.Equals(4) && config.tipLabelI18nCode.IsNotEmptyOrNull() ? $"<BasicHelp :text=\"t('{config.tipLabelI18nCode}', '{config.tipLabel}')\"/> " : (config.tipLabel.IsNotEmptyOrNull() ? $"<BasicHelp text='{config.tipLabel}'/> " : string.Empty),
                                        Tag = config.tag,
                                        Style = !string.IsNullOrEmpty(item.style?.ToString()) ? string.Format(":style='{0}' ", JsonConvert.SerializeObject(item.style)) : string.Empty,
                                        LabelWidth = config?.labelWidth ?? formDataModel.labelWidth,
                                    };
                                    break;
                                default:
                ...
                switch (config.ceriKey)
                {
                    ...
                    case CeriKeyConst.COMINPUT:
                        ...
                        formControlDesignModel.MaskConfig = item.maskConfig != null ? $":maskConfig='{JsonConvert.SerializeObject(item.maskConfig)}' " : string.Empty;
                    ...
                    case CeriKeyConst.TEXTAREA:
                        formControlDesignModel.Placeholder = placeholder;
                        formControlDesignModel.MaxLength = item.maxlength != null ? string.Format(":maxlength=\"{0}\" ", item.maxlength) : string.Empty;
                        formControlDesignModel.AutoSize = !string.IsNullOrEmpty(item.autoSize?.ToString()) ? string.Format(":autoSize='{0}' ", JsonConvert.SerializeObject(item.autoSize)) : string.Empty;
                        formControlDesignModel.Clearable = item.clearable ? string.Format("allowClear ") : string.Empty;
                        formControlDesignModel.Readonly = item.@readonly ? string.Format("readonly ") : string.Empty;
                        break;
                    case CeriKeyConst.NUMINPUT:
                        ...
                        formControlDesignModel.Controls = string.Format(":controls={0} ", item.controls.ToString().ToLower());
                        ...
                        switch (!string.IsNullOrEmpty(formControlDesignModel.AbleIds))
                        {
                            case true:
                                options.Add(new CodeGenFrontEndFormState()
                                {
                                    ...
                                    Value = item.ableIds != null ? JsonConvert.SerializeObject(item.ableIds) : "[]"
                                });
                                break;
                        }
                    ...
                    case CeriKeyConst.POPUPSELECT:
                        {
                            options.Add(new CodeGenFrontEndFormState()
                            {
                                ...
                                Value = JsonConvert.SerializeObject(item.columnOptions, CommonConst.options)
                            });
                            var json = JsonConvert.SerializeObject(item.templateJson);
                            options.Add(new CodeGenFrontEndFormState()
                            {
                                Name = string.Format("{0}TemplateJson", isSubTable ? string.Format("{0}_{1}", subTableName, item.__vModel__) : item.__vModel__),
                                Value = json.Equals(string.Empty) ? JsonConvert.SerializeObject(new List<string>()) : json
                            });
                            if (!isSubTable)
                            {
                                if (item.extraOptions != null)
                                {
                                    extraOptions.Add(new CodeGenFrontEndFormState()
                                    {
                                        ...
                                        Value = JsonConvert.SerializeObject(item.extraOptions, CommonConst.options)
                                    });
                                }
                    ...
                    case CeriKeyConst.SELECT:
                        switch (config.dataType)
                        {
                            ...
                            default:
                                ...
                                var id = string.Empty;
                                var templateJson = JsonConvert.SerializeObject(new List<string>());
                                switch (dataTypeEnum)
                                {
                                    ...
                                    case CodeGenFrontEndDataType.dynamic:
                                        id = config.propsUrl;
                                        templateJson = JsonConvert.SerializeObject(config.templateJson);
                                        break;
                                }
                    ...
                    case CeriKeyConst.CASCADER:
                        switch (config.dataType)
                        {
                            case "static":
                                ...
                                {
                                    Name = string.Format("{0}Props", isSubTable ? string.Format("{0}_{1}", subTableName, item.__vModel__) : item.__vModel__),
                                    Value = JsonConvert.SerializeObject(item.props, CommonConst.options)
                                });
                                break;
                            default:
                                if (!(realisticControl?.IsLinkage).ParseToBool() && isSubTable)
                    ...
                    case CeriKeyConst.ADDRESS:
                        {
                            ...
                            formState.Value = config.defaultValue is null ? JsonConvert.SerializeObject(new List<string>()) : JsonConvert.SerializeObject(config.defaultValue);
                    ...
                    case CeriKeyConst.COMSELECT:
                        {
                            ...
                            {
                                case true:
                                    formState.Value = string.Format("userInfo.organizeIdList.length ? {0}userInfo.organizeIdList{1} : {2}", item.multiple ? "[" : string.Empty, item.multiple ? "]" : string.Empty, item.multiple ? JsonConvert.SerializeObject(new List<string>()) : "\"\"");
                                    break;
                                default:
                                    formState.Value = config.defaultValue is null ? JsonConvert.SerializeObject(new List<string>()) : JsonConvert.SerializeObject(config.defaultValue);
                                    break;
                                ...
                                case true:
                                    switch (config.ceriKey)
                                    {
                                        ...
                                        case CeriKeyConst.GROUPSELECT:
                                            ...
                                            break;
                                        case CeriKeyConst.DEPSELECT:
                                            formState.Value = string.Format("userInfo.departmentId ? {0}userInfo.departmentId{1} : {2}", item.multiple ? "[" : string.Empty, item.multiple ? "]" : string.Empty, item.multiple ? JsonConvert.SerializeObject(new List<string>()) : "\"\"");
                                            break;
                                    }
                                    break;
                                default:
                    ...
                    case CeriKeyConst.USERSELECT:
                        {
                            ...
                            {
                                case true:
                                    formState.Value = string.Format("userInfo.userId ? {0}userInfo.userId{1} : {2}", item.multiple ? "[" : string.Empty, item.multiple ? "]" : string.Empty, item.multiple ? JsonConvert.SerializeObject(new List<string>()) : "\"\"");
                                    break;
                                default:
                                    switch (item.multiple)
                                    {
                    ...
                    case CeriKeyConst.LOCATION:
                        {
                            var formState = new CodeGenFrontEndFormState();
                            formState.Name = item.__vModel__;
                            formState.Value = item.__config__.defaultValue != null ? JsonConvert.SerializeObject(item.__config__.defaultValue) : "undefined";
                            dataForm.Add(formState);
                            if ((columnDesignModel?.Any(it => it.__vModel__.Equals(item.__vModel__))).ParseToBool())
                                inlineEditorDataForm.Add(formState);
                        }
                ...
                switch (config.ceriKey)
                {
                    ...
                    case CeriKeyConst.CASCADER:
                        if ((realisticControl?.IsLinkage).ParseToBool() && isSubTable && !mainLinkageSubTable.Any(it => it.Name.Equals(subTableName) && it.Value.Equals(item.__vModel__)))
                        {
                            ...
                            formState.Value = JsonConvert.SerializeObject(new List<string>());
                            dataForm.Add(formState);
                        }
        ...
        switch (fieldList.Any(it => it.__vModel__.Equals(relationField)))
        {
            ...
            case false:
                if (relationField.IsMatch(@"tableField\d{3}-"))
                {
                    ...
                    switch (fieldList.Any(it => it.__config__.ceriKey.Equals(CeriKeyConst.TABLE) && it.__config__.children.Any(x => x.__vModel__.Equals(relationField))))
                    {
                        case true:
    ...
    public static DefaultFormControlModel DefaultFormControlList(List<FieldsModel> fieldList, List<IndexSearchFieldModel> searchField, string subTableName = null, bool isMain = true)
    {
        ...
        foreach (var item in fieldList)
        {
            ...
            switch (isMain && !config.ceriKey.Equals(CeriKeyConst.TABLE))
            {
                case false:
                    switch (!config.ceriKey.Equals(CeriKeyConst.TABLE))
                    {
                        case true:
                    ...
                    switch (config.ceriKey)
                    {
                        ...
                        case CeriKeyConst.COMSELECT:
                            model.ComSelectList.Add(new DefaultComSelectControl()
                            {
                                ...
                                Field = item.__vModel__,
                                ableIds = JsonConvert.SerializeObject(item.ableIds),
                            });
                            break;
                        case CeriKeyConst.DEPSELECT:
    ...
    /// <returns></returns>
    public static bool DetermineWhetherTheControlHasEnabledSpecialAttributes(List<FieldsModel> fieldList, string ceriKey)
    {
        ...
        foreach (var item in fieldList)
        {
            ...
            {
                case CeriKeyConst.TABLE:
                    numberOfControls += DetermineWhetherSpecialAttributesAreEnabledForControlsWithinASubtable(config.children, ceriKey);
                    break;
                case CeriKeyConst.DATE:
                case CeriKeyConst.TIME:
                    if (config.ceriKey.Equals(ceriKey) & (config.startTimeRule || config.endTimeRule))
                    {
                        numberOfControls++;
                    }
                    break;
    ...
    private static int DetermineWhetherSpecialAttributesAreEnabledForControlsWithinASubtable(List<FieldsModel> fieldList, string ceriKey)
    {
        var numberOfControls = 0;
        foreach (var item in fieldList)
        {
                                ...
                                case CeriKeyConst.USERSSELECT:
                                    if (children.selectType != null && children.selectType == "custom")
                                    {
                                        list.Add(new CodeGenConvIndexListControlOptionDesign()
                                        {
                                            ...
                                            IsIndex = false,
                                            IsProps = false,
                                            Content = string.Format("{0}_{1}_AbleIds:{2},", item.__vModel__, children.__vModel__, JsonConvert.SerializeObject(children.ableIds)),
                                        });
                                    }
                                    break;
                                case CeriKeyConst.SELECT:
                                        ...
                                        switch (childrenConfig.dataType)
                                        {
                                            ...
                                            case "static":
                                                list.Add(new CodeGenConvIndexListControlOptionDesign()
                                                {
                                                    ...
                                                    QueryProps = JsonConvert.SerializeObject(children.props, CommonConst.options),
                                                });
                                                break;
                                            default:
                                                list.Add(new CodeGenConvIndexListControlOptionDesign()
                                                {
                                                    ...
                                                    QueryProps = JsonConvert.SerializeObject(children.props, CommonConst.options),
                                                    IsLinkage = realisticControl.IsLinkage,
                                                    TemplateJson = childrenConfig.dataType == "dynamic" ? JsonConvert.SerializeObject(childrenConfig.templateJson) : "[]"
                                                });
                                                break;
                                        }
                                    }
                                        ...
                                        switch (childrenConfig.dataType)
                                        {
                                            case "static":
                                                list.Add(new CodeGenConvIndexListControlOptionDesign()
                                                {
                                                    ...
                                                    IsProps = true,
                                                    IsChildren = true,
                                                    Props = JsonConvert.SerializeObject(children.props, CommonConst.options),
                                                    QueryProps = JsonConvert.SerializeObject(children.props, CommonConst.options),
                                ...
                                case CeriKeyConst.AUTOCOMPLETE:
                                    {
                                        ...
                                        list.Add(new CodeGenConvIndexListControlOptionDesign()
                                        {
                                            ...
                                            Props = null,
                                            IsChildren = true,
                                            Content = $"{string.Format("{0}_{1}", item.__vModel__, children.__vModel__)}Options: {JsonConvert.SerializeObject(children.columnOptions, CommonConst.options)},",
                                            IsLinkage = realisticControl.IsLinkage,
                                            TemplateJson = JsonConvert.SerializeObject(children.templateJson)
                                        });
                                    }
                ...
                case CeriKeyConst.COLLAPSE:
                    {
                        ...
                        list.Add(new CodeGenConvIndexListControlOptionDesign()
                        {
                            ...
                            IsProps = false,
                            IsChildren = false,
                            Content = JsonConvert.SerializeObject(config.active),
                ...
                case CeriKeyConst.STEPS:
                    {
                        ...
                        list.Add(new CodeGenConvIndexListControlOptionDesign()
                        {
                            ...
                            IsProps = false,
                            IsChildren = false,
                            Content = config.ceriKey.Equals(CeriKeyConst.STEPS) ? config.active.ToString() : (config.children.FindLastIndex(x => x.name != null && x.name.Equals(config.active)) + 1).ToString(),
                            Title = JsonConvert.SerializeObject(title).Replace("\"@@this.$t('", "this.$t('").Replace("@@')\"", "')"),
                        });
                    }
                ...
                case CeriKeyConst.USERSSELECT:
                    if (item.selectType != null && item.selectType == "custom")
                    {
                        list.Add(new CodeGenConvIndexListControlOptionDesign()
                        {
                            ...
                            IsIndex = false,
                            IsProps = false,
                            Content = string.Format("{0}_AbleIds:{1},", item.__vModel__, JsonConvert.SerializeObject(item.ableIds)),
                        });
                    }
                            ...
                            case CeriKeyConst.AUTOCOMPLETE:
                                {
                                    list.Add(new CodeGenConvIndexListControlOptionDesign()
                                    {
                                        ...
                                        Props = null,
                                        IsChildren = false,
                                        Content = string.Format("{0}Options: {1},", item.__vModel__, JsonConvert.SerializeObject(item.columnOptions, CommonConst.options)),
                                        TemplateJson = JsonConvert.SerializeObject(item.templateJson)
                                    });
                                }
                                    ...
                                    switch (config.dataType)
                                    {
                                        case "static":
                                            list.Add(new CodeGenConvIndexListControlOptionDesign()
                                            {
                                                ...
                                                QueryProps = JsonConvert.SerializeObject(item.props, CommonConst.options),
                                                IsChildren = false,
                                        ...
                                        default:
                                            list.Add(new CodeGenConvIndexListControlOptionDesign()
                                            {
                                                ...
                                                TemplateJson = config.dataType == "dynamic" ? JsonConvert.SerializeObject(config.templateJson) : "[]"
                                            });
                                            break;
                                    }
                                }
                            ...
                            case CeriKeyConst.CASCADER:
                                {
                                    ...
                                    {
                                        case "static":
                                            var newData = new CodeGenConvIndexListControlOptionDesign();
                                            newData.ceriKey = config.ceriKey;
                                            newData.Name = item.__vModel__;
                                            newData.DictionaryType = config.dataType == "dictionary" ? config.dictionaryType : (config.dataType == "dynamic" ? config.propsUrl : null);
                                            newData.DataType = config.dataType;
                                            newData.IsStatic = true;
                                            newData.IsIndex = true;
                                            newData.IsProps = true;
                                            newData.IsChildren = false;
                                            newData.Props = JsonConvert.SerializeObject(item.props, CommonConst.options);
                                            newData.QueryProps = JsonConvert.SerializeObject(item.props, CommonConst.options);
                                            newData.Content = GetCodeGenConvIndexListControlOption(item.__vModel__, item.options);
                                            list.Add(newData);
                                            break;
                                        default:
                                            list.Add(new CodeGenConvIndexListControlOptionDesign()
                                            {
                                                ...
                                                IsProps = true,
                                                IsChildren = false,
                                                Props = JsonConvert.SerializeObject(item.props, CommonConst.options),
                                                QueryProps = JsonConvert.SerializeObject(item.props, CommonConst.options),
                                                Content = string.Format("{0}Options: [],", item.__vModel__),
                                                TemplateJson = config.dataType == "dynamic" ? JsonConvert.SerializeObject(config.templateJson) : "[]"
                                            });
                ...
                case CeriKeyConst.TABLE:
                    {
                                ...
                                case CeriKeyConst.POPUPATTR:
                                    {
                                        if (children.isStorage == 1)
                                        {
                                            childrenFormScript.Add(new FormScriptDesignModel()
                                            {
                                                ...
                                                Trigger = string.IsNullOrEmpty(childrenConfig.trigger?.ToString()) ? "blur" : (childrenConfig.trigger is Array ? JsonConvert.SerializeObject(childrenConfig.trigger) : childrenConfig.trigger.ToString()),
                                                ChildrenList = null,
                                                IsSummary = item.showSummary && item.summaryField.Any(it => it.Equals(children.__vModel__)) ? true : false,
                                ...
                                case CeriKeyConst.LOCATION:
                                    {
                                        childrenFormScript.Add(new FormScriptDesignModel()
                                        {
                                            ...
                                            Range = children.range,
                                            RegList = childrenConfig.regList,
                                            DefaultValue = JsonConvert.SerializeObject(childrenConfig.defaultValue),
                                            Trigger = string.IsNullOrEmpty(childrenConfig.trigger?.ToString()) ? "blur" : (childrenConfig.trigger is Array ? JsonConvert.SerializeObject(childrenConfig.trigger) : childrenConfig.trigger.ToString()),
                                            ChildrenList = null,
                                            IsSummary = item.showSummary && item.summaryField.Any(it => it.Equals(children.__vModel__)) ? true : false,
                                            IsLinked = children.IsLinked,
                                            ...
                                            LocationScope = item.locationScope != null ? JsonConvert.SerializeObject(item.locationScope) : "[]",
                                        });
                                    }
                        ...
                        formScript.Add(new FormScriptDesignModel()
                        {
                            ...
                            ChildrenThousandsField = JsonConvert.SerializeObject(childrenFormScript.FindAll(it => it.Thousands.Equals(true)).Select(it => it.Name).ToList()),
                            ColumnBtnsList = item.columnBtnsList.Where(x => x.show).ToList(),
                            FooterBtnsList = item.footerBtnsList.Where(x => x.show).ToList(),
                            IsAnyBatchRemove = item.footerBtnsList.Any(x => x.show && x.value.Equals("batchRemove")),
                            LayoutType = item.layoutType,
                ...
                case CeriKeyConst.POPUPATTR:
                    {
                        if (item.isStorage == 1)
                        {
                            ...
                            formScript.Add(new FormScriptDesignModel()
                            {
                                ...
                                Range = item.range,
                                RegList = config.regList,
                                DefaultValue = JsonConvert.SerializeObject(config.defaultValue),
                                Trigger = !string.IsNullOrEmpty(config.trigger?.ToString()) ? (config?.trigger is Array ? JsonConvert.SerializeObject(config?.trigger) : config?.trigger?.ToString()) : "blur",
                                ChildrenList = null,
                                IsLinked = item.IsLinked,
                                LinkageRelationship = item.linkageReverseRelationship,
                ...
                case CeriKeyConst.SWITCH:
                    {
                        ...
                        formScript.Add(new FormScriptDesignModel()
                        {
                            ...
                            Trigger = string.IsNullOrEmpty(config.trigger?.ToString()) ? "blur" : (config.trigger is Array ? JsonConvert.SerializeObject(config.trigger) : config.trigger.ToString()),
                            ChildrenList = null,
                            IsLinked = item.IsLinked,
                            LinkageRelationship = item.linkageReverseRelationship
                        });
                ...
                default:
                    {
                        ...
                        if (item.__vModel__.Contains("_ceri_"))
                        {
                            var auxiliaryTableName = item.__vModel__.Matches(@"jnpf_(?<table>[\s\S]*?)_jnpf_", "table").Last();
                            var column = item.__vModel__.Replace(item.__vModel__.Matches(@"jnpf_(?<table>[\s\S]*?)_jnpf_").Last(), string.Empty);
                            var columns = tableColumns.Find(it => it.LowerColumnName.Equals(column) && it.IsAuxiliary.Equals(true) && (bool)it.TableName?.Equals(auxiliaryTableName));
    ...
    private static string GetCodeGenConvIndexListControlOption(string name, List<Dictionary<string, object>> options)
    {
        ...
        if (options != null)
        {
            ...
            sb.Append("[");
            foreach (var valueItem in options)
            {
                sb.Append("{");
                foreach (var items in valueItem)
                {
                    sb.AppendFormat("'{0}':{1},", items.Key, JsonConvert.SerializeObject(items.Value));
                }
    ...
    private static string GetUserRelationAttr(FieldsModel field, List<FieldsModel> fieldList, int logic)
    {
        ...
        // 用户控件联动
        if (field.__config__.ceriKey.Equals(CeriKeyConst.USERSELECT) && field.relationField.IsNotEmptyOrNull())
        {
            var relationField = fieldList.Find(x => x.__vModel__.Equals(field.relationField));
            if (relationField == null && field.relationField.ToLower().Contains("tablefield") && fieldList.Any(x => x.__config__.ceriKey.Equals(CeriKeyConst.TABLE)))
            {
        ...
        foreach (var item in realisticControls)
        {
            ...
            switch (config.ceriKey)
            {
                ...
                case CeriKeyConst.TABLE:
                    ...
                    {
                        switch (subtable.__config__.ceriKey)
                        {
                            case CeriKeyConst.CALCULATE:
                                break;
                            case CeriKeyConst.POPUPATTR:
                                ...
                                switch (subtable.isStorage)
                                {
                                    case 1:
                                        list.Add(new CodeGenExportPropertyJsonModel
                                        {
                                            ...
                                            ceriKey = subtable.__config__.ceriKey,
