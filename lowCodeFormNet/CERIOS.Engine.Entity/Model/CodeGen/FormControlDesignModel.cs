...
public class FormControlDesignModel
{
    ...
    /// 是否自定义选择.
    /// </summary>
    public bool IsCustomSelect => ceriKey != null && (ceriKey.Equals(CeriKeyConst.USERSELECT) || ceriKey.Equals(CeriKeyConst.USERSSELECT) || ceriKey.Equals(CeriKeyConst.DEPSELECT) || ceriKey.Equals(CeriKeyConst.POSSELECT) || ceriKey.Equals(CeriKeyConst.COMSELECT) || ceriKey.Equals(CeriKeyConst.ROLESELECT) || ceriKey.Equals(CeriKeyConst.GROUPSELECT)) ? (SelectType == "all" ? false : true) : false;
