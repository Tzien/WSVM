using CERIOS.ConfigurableOptions.Attributes;
...
namespace CERIOS.ConfigurableOptions
{
    internal static class Penetrates
    {
        ...
        {
            if (App.App.RootServices == null && typeof(IConfigurableOptions).IsAssignableFrom(typeof(TOptions)))
            {
                var (_, path) = GetOptionsConfiguration(typeof(TOptions));
                return App.App.GetConfig<TOptions>(path, true);
            }
