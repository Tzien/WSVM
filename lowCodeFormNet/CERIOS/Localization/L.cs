using CERIOS.AspNerCore.Extensions;
...
public static class L
{
    ...
    /// String 多语言
    /// </summary>
    public static IStringLocalizer Text => App.App.GetService<IStringLocalizerFactory>(App.App.RootServices)?.Create();

    /// <summary>
    /// Html 多语言
    /// </summary>
    public static IHtmlLocalizer Html => App.App.GetService<IHtmlLocalizerFactory>(App.App.RootServices)?.Create();
    ...
    {
        return App.App.GetService<IStringLocalizer<T>>(App.App.RootServices);
    }
    ...
    {
        return App.App.GetService<IHtmlLocalizer<T>>(App.App.RootServices);
    }
    ...
    public static void SetCulture(string culture, bool immediately = false)
    {
        ...
        // 修复 DateTime 问题
        Penetrates.FixedCultureDateTimeFormat(cultureInfo, App.App.GetOptions<LocalizationSettingsOptions>()?.DateTimeFormatCulture);
    ...
    public static void SetCurrentUICulture(string culture)
    {
        ...
        Penetrates.FixedCultureDateTimeFormat(CultureInfo.CurrentUICulture
            , App.App.GetOptions<LocalizationSettingsOptions>()?.DateTimeFormatCulture);
    }
    ...
    {
        // 获取本地多语言配置
        var localizationSettings = App.App.GetOptions<LocalizationSettingsOptions>();
