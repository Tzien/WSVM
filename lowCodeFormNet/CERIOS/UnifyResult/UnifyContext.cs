...
public static class UnifyContext
{
    ...
    public static ExceptionMetadata GetExceptionMetadata(ActionContext context)
    {
        ...
        if (!isValidationException)
        {
            ...
            {
                var friendlyExceptionSettings = App.App.GetOptions<FriendlyExceptionSettingsOptions>();
    ...
    {
        var items = App.App.HttpContext?.Items;
        if (items == null)
        {
            return;
        }
    ...
    {
        object extras = null;
        App.App.HttpContext?.Items?.TryGetValue(UnifyResultExtrasKey, out extras);
        return extras;
    }
    ...
    internal static bool CheckSucceededNonUnify(MethodInfo method, out IUnifyResultProvider unifyResult, bool isWebRequest = true)
    {
        ...
        unifyResult = isSkip ? null : App.App.RootServices.GetService(unityMetadata.ProviderType) as IUnifyResultProvider;
