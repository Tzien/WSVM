...
namespace CERIOS.DataValidation;
...
public static class DataValidator
{
    ...
    private static IEnumerable<Type> GetValidationTypes()
    {
        ...
        var validationTypes = App.App.EffectiveTypes.Where(u => u.IsDefined(typeof(ValidationTypeAttribute), true) && u.IsEnum);
    ...
    private static IEnumerable<Type> GetValidationMessageTypes()
    {
        ...
        var validationMessageTypes = App.App.EffectiveTypes
            .Where(u => u.IsDefined(typeof(ValidationMessageTypeAttribute), true) && u.IsEnum);

        // 加载自定义验证消息类型提供器
        var validationMessageTypeProvider = App.App.GetService<IValidationMessageTypeProvider>(App.App.RootServices);
    ...
    private static ConcurrentDictionary<string, ValidationItemMetadataAttribute> GetValidationValidationItemMetadatas()
    {
        ...
        // 加载配置文件配置
        var validationTypeMessageSettings = App.App.GetConfig<ValidationTypeMessageSettingsOptions>("ValidationTypeMessageSettings", true);
