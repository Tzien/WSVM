...
namespace CERIOS.ObjectMapper.Extensions;
...
public static class ObjectMapperServiceCollectionExtensions
{
    ...
    /// 对象映射程序集名称
    /// </summary>
    public const string ASSEMBLY_NAME = "CERIOS.Extras.ObjectMapper.Mapster";
    ...
    {
        // 判断是否安装了 Mapster 程序集
        var objectMapperAssembly = App.App.Assemblies.FirstOrDefault(u => u.GetName().Name.Equals(ASSEMBLY_NAME));
        if (objectMapperAssembly != null)
        {
            ...
            return addObjectMapperMethod.Invoke(null, new object[] { services, App.App.Assemblies.ToArray() }) as IServiceCollection;
        }
