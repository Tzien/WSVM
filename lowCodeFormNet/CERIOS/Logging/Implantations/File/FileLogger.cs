...
public sealed class FileLogger : ILogger
{
        ...
        , Func<TState, Exception, string> formatter)
    {
        ...
        var logMsg = new LogMessage(_logName, logLevel, eventId, message, exception, null, state, logDateTime, Environment.CurrentManagedThreadId, _options.UseUtcTimestamp, App.App.GetTraceId())
        {
            // 设置日志上下文
