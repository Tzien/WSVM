...
using CERIOS.DependencyInjection.Enums;
using CERIOS.DependencyInjection.Options;
using CERIOS.DependencyInjection.Providers;
using CERIOS.DynamicApiController;
using CERIOS.Reflection;
using CERIOS.Reflection.Proxies;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;
using System.Collections.Concurrent;
using System.Reflection;

namespace CERIOS.DependencyInjection.Extensions
{
    /// <summary>
    /// 依赖注入拓展类
    /// </summary>
    public static class DependencyInjectionServiceCollectionExtensions
    {
            ...
            where TIDispatchProxy : class
        {
            ...
            // 获取所有的代理接口类型
            var dispatchProxyInterfaceTypes = App.App.EffectiveTypes
        ...
        {
            // 查找所有需要依赖注入的类型
            var injectTypes = App.App.EffectiveTypes
        ...
        {
            // 获取选项
            var externalServices = App.App.GetConfig<DependencyInjectionSettingsOptions>("DependencyInjectionSettings", true);
        ...
        {
            // 获取全局代理类型
            GlobalServiceProxyType = App.App.EffectiveTypes
