...
namespace CERIOS.FriendlyException.Results
{
    public class BadPageResult: StatusCodeResult
    {
        ...
        public override string ToString()
        {
            ...
            // 读取嵌入式页面路径
            var errorhtml = $"{Reflect.GetAssemblyName(thisAssembly)}{thisType.Namespace.Replace(nameof(CERIOS), string.Empty)}.Assets.error.html";
