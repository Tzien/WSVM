...
namespace CERIOS.VirtualFileServer;
...
public static class FS
{
    ...
    {
        var fileProviderResolve = App.App.GetService<Func<FileProviderTypes, object, IFileProvider>>(serviceProvider ?? App.App.RootServices);
