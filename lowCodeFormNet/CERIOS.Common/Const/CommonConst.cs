...
public class CommonConst
{
    ...
    /// 全局租户缓存.
    /// </summary>
    public const string GLOBALTENANT = "ceri:global:tenant";

    /// <summary>
    /// 集成助手缓存.
    /// </summary>
    public const string INTEASSISTANT = "ceri:global:integrate";

    /// <summary>
    /// 集成助手重试缓存.
    /// </summary>
    public const string INTEASSISTANTRETRY = "ceri:global:integrate:retry";

    /// <summary>
    /// 集成助手WebHook.
    /// </summary>
    public const string INTEGRATEWEBHOOK = "ceri:global:integrate:webhook";
    ...
    /// 用户缓存.
    /// </summary>
    public const string CACHEKEYUSER = "ceri:permission:user";
    ...
    /// 在线用户缓存.
    /// </summary>
    public const string CACHEKEYONLINEUSER = "ceri:user:online";

    /// <summary>
    /// 全局组织树缓存.
    /// </summary>
    public const string CACHEKEYORGANIZE = "ceri:global:organize";
    ...
    /// 门户日程缓存key.
    /// </summary>
    public const string CACHEKEYSCHEDULE = "ceri:portal:schedule";
