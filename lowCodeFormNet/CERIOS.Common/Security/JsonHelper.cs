...
namespace CERIOS.Common.Security;
...
public static class JsonHelper
{
    ...
    /// 序列化提供器.
    /// </summary>
    public static IJsonSerializerProvider _jsonSerializer = App.App.GetService(typeof(NewtonsoftJsonSerializerProvider), App.App.RootServices) as IJsonSerializerProvider;
