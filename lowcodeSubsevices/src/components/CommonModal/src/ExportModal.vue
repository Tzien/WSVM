...
<script lang="ts" setup>
  ...
  import { noGroupList } from '@/views/WebDesign/component/StepForm/src/helper/config';
  ...
  function init(data) {
    ...
    columnList.value = cloneDeep(data.columnList).filter(o => !noGroupList.includes(o.__config__.ceriKey));
