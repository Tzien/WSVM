<template>
  <BasicModal
    ...
    :closable="false"
    :keyboard="false"
    class="ceri-full-modal full-modal designer-modal"
    :class="`${prefixCls}`">
    <template #title>
      <div class="ceri-full-modal-header">
        <div class="header-title !w-auto">
          <img src="@/assets/images/ceri.png" class="header-logo" />
          ...
          <a-popover
            ...
            trigger="click"
            placement="bottom"
            overlayClassName="ceri-version-popover"
    ...
    <PrintDesign ref="printDesignRef" v-bind="getBindValue" v-if="!loading" />
  </BasicModal>
</template>
