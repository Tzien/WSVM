        ...
        <template v-if="activeData.type === 'select'">
          ...
          <div v-if="activeData.config.dataType === 'dictionary'">
            ...
            <a-form-item label="存储字段">
              <ceri-select v-model:value="activeData.config.propsValue" placeholder="请选择" :options="valueOptions" />
            </a-form-item>
          </div>
        </template>
        <a-form-item label="日期类型" v-if="activeData.type === 'date'">
          <ceri-select v-model:value="activeData.config.format" placeholder="请选择" :options="dateFormatOptions" />
        </a-form-item>
        <a-form-item label="日期类型" v-if="activeData.type === 'time'">
          <ceri-select v-model:value="activeData.config.format" placeholder="请选择" :options="timeFormatOptions" />
        </a-form-item>
