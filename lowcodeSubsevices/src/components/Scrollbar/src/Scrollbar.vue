<template>
  <div class="scrollbar">
    <div ref="wrap" :class="[wrapClass, 'scrollbar__wrap', native ? '' : 'scrollbar__wrap--hidden-default']" :style="style" @scroll="handleScroll">
      <component :is="tag" ref="resize" :class="['scrollbar_view', viewClass]" :style="viewStyle">
        <slot></slot>
      </component>
    </div>
...
<script lang="ts">
import { defineComponent, computed, ref, unref, CSSProperties, PropType, StyleValue, onMounted, onBeforeMount, provide, nextTick } from 'vue'
