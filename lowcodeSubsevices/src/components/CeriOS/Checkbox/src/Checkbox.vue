...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'CeriCheckbox', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `ceri-${props.direction}-checkbox ${unref(attrs).class}` : `ceri-${props.direction}-checkbox`,
  }));
