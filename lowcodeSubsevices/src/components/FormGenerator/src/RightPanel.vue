    ...
    <div class="field-box" v-if="activeData?.__config__ && activeData.__config__.ceriKey">
      <ScrollContainer>
        <a-form :colon="false" layout="vertical" v-show="activeKey === 'field'" class="right-board-form">
          ...
          <a-form-item label="控件标题2" v-if="!layoutList.includes(ceriKey) || ceriKey === 'table'">
            <ceri-i18n-input v-model:value="activeData.__config__.label" v-model:i18n="activeData.__config__.labelI18nCode" placeholder="请输入" />
          </a-form-item>
          ...
          <a-form-item label="标题提示" v-if="hasTipLabel(ceriKey)">
            <ceri-i18n-input v-model:value="activeData.__config__.tipLabel" v-model:i18n="activeData.__config__.tipLabelI18nCode" placeholder="请输入" />
          </a-form-item>
