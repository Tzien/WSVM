      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="Id" :labelCol="{ style: { width: '100px' } }">
              <template #label>用户ID</template>
              <CeriInput v-model:value="dataForm.Id" placeholder='请输入' allowClear :style='{"width":"100%"}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="RealName" :labelCol="{ style: { width: '100px' } }">
              <template #label>姓名</template>
              <CeriInput v-model:value="dataForm.RealName" placeholder='请输入' allowClear :style='{"width":"100%"}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="Sex" :labelCol="{ style: { width: '100px' } }">
              <template #label>性别</template>
              <CeriRadio v-model:value="dataForm.Sex" :options="optionsObj.SexOptions" :fieldNames="optionsObj.SexProps" direction="horizontal" optionType="default" :style='{"width":"100%"}'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    ...
    optionsObj:{
      EnabledOptions: [{'fullName':"是",'id':"1"},{'fullName':"否",'id':"0"}],
      EnabledProps: {'label':'fullName','value':'id'},
      SexOptions: [{'fullName':"男",'id':"0"},{'fullName':"女",'id':"1"}],
