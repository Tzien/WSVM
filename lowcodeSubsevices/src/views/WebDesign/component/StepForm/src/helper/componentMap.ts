...
export const selectComponents: GenItem[] = [
  // {
  //   __config__: {
  //     ceriKey: 'organizeSelect',
  //     label: '组织选择',
  //     tipLabel: '',
  //     labelWidth: undefined,
  //     showLabel: true,
  //     tag: 'CeriOrganizeSelect',
  ...
  {
    __config__: {
      ceriKey: 'popupTableSelect',
      label: '下拉表格',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      required: false,
      tag: 'CeriPopupTableSelect',
  ...
  {
    __config__: {
      ceriKey: 'autoComplete',
      label: '下拉补全',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      required: false,
      tag: 'CeriAutoComplete',
  ...
  {
    __config__: {
      ceriKey: 'relationForm',
      label: '关联表单',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'CeriRelationForm',
  ...
  {
    __config__: {
      ceriKey: 'relationFormAttr',
      label: '关联表单属性',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'CeriRelationFormAttr',
