    ...
    <a-row class="dynamic-form ">
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="SysInfoID" :labelCol="{ style: { width: '100px' } }">
              <template #label>系统ID</template>
              <CeriInput v-model:value="dataForm.SysInfoID" placeholder='请输入' allowClear :style='{"width":"100%"}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="IsActive" :labelCol="{ style: { width: '100px' } }">
              <template #label>是否启用</template>
              <CeriSwitch v-model:value="dataForm.IsActive"  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
