    ...
    <a-row class="dynamic-form ">
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="PictureURL" :labelCol="{ style: { width: '100px' } }">
              <template #label>图片上传</template>
              <CeriUploadImg v-model:value="dataForm.PictureURL" pathType="defaultPath" sizeUnit="MB" :fileSize="10"  :sortRule='[]' timeFormat='YYYY' />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
