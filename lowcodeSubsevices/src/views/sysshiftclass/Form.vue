      ...
      <a-form :colon="false" layout="horizontal" labelAlign="right"  :labelCol="{ style: { width: '100px' } }" :model="dataForm" :rules="dataRule" ref="formRef">
        <a-row :gutter="15">
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="ModuleName" :labelCol="{ style: { width: '100px' } }">
              <template #label>班组名称</template>
              <CeriInput v-model:value="dataForm.ModuleName" placeholder='请输入' allowClear :style='{"width":"100%"}'  :showCount='false'  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="Code" :labelCol="{ style: { width: '100px' } }">
              <template #label>班组编码</template>
          ...
          <a-col :span="24" class="ant-col-item" >
            <a-form-item name="IsDeleted" :labelCol="{ style: { width: '100px' } }">
              ...
              <CeriSwitch v-model:value="dataForm.IsDeleted"  />
            </a-form-item>
          </a-col>
          <a-col :span="24" class="ant-col-item" >
