<template>
  <BasicModal
    ...
    @ok="handleSubmit"
    destroyOnClose
    class="ceri-super-query-modal ceri-condition-modal">
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    planList: [],
    conditionList: [
      { logic: 'and', groups: [{ field: '', symbol: '', ceriKey: '', fieldValueType: 2, fieldValue: undefined, fieldValueCeriKey: '', cellKey: +new Date() }] },
    ],
