<template>
  <a-modal v-model:open="visible" title="个人签名" class="ceri-sign-list-modal" centered :maskClosable="false" :keyboard="false" :width="600">
    <template #closeIcon>
    ...
    <div class="sign-list-main">
      ...
      <ceri-empty v-if="!signList.length" />
    </div>
  </a-modal>
</template>
...
<style lang="less">
  html[data-theme='dark'] {
    .ceri-sign-list-modal .sign-list .sign-item .sign-item-main {
      background-color: #fff;
    }
  }
  .ceri-sign-list-modal {
    .ant-modal-body {
