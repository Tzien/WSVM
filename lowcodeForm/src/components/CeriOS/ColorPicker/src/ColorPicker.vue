<template>
  <a-popover
    ...
    trigger="click"
    class="ceri-color-picker"
    :class="[colorSize ? 'ceri-color-picker--' + colorSize : '']"
    v-bind="$attrs"
    v-if="!colorDisabled">
    <template #content>
  ...
  <div
    class="ceri-color-picker ant-color-picker__trigger is-disabled"
    :class="[colorSize ? 'ceri-color-picker--' + colorSize : '']"
...
<style lang="less" scoped>
  ...
  // large 大小
  .ceri-color-picker--large {
    width: 40px;
    height: 40px;
  }

  //small 大小
  .ceri-color-picker--small {
    width: 32px;
    height: 32px;
  }
</style>
