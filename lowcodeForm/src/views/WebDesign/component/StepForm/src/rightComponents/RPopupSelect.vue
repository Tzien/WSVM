<template>
  <a-form-item label="弹窗标题" v-if="ceriKey === 'popupSelect'">
    <a-input v-model:value="activeData.popupTitle" placeholder="请输入" />
  </a-form-item>
  <a-form-item label="弹窗类型" v-if="ceriKey === 'popupSelect' && showType === 'pc'">
    <ceri-select v-model:value="activeData.popupType" placeholder="请选择" :options="popupTypeOptions" />
  </a-form-item>
  <a-form-item label="弹窗宽度" v-if="ceriKey === 'popupSelect' && showType === 'pc'">
  ...
  <a-form-item v-if="ceriKey === 'popupSelect'">
  ...
  <a-divider v-if="ceriKey === 'popupSelect' && !activeData.__config__.isSubTable">显示字段</a-divider>
  <div class="options-list" v-if="ceriKey === 'popupSelect' && !activeData.__config__.isSubTable">
  ...
  <a-form-item label="能否多选" v-if="ceriKey === 'popupTableSelect'">
