    ...
    <div style="display: flex; align-items: center; justify-content: space-between; height: 36px; line-height: 36px; margin-top: 17px">
      ...
      <div style="padding-right: 20px">
        <CustomIconButtonList
          ...
          :BtnFunctionNameArray="['ImportDemo', 'ExportDemo', 'FormTableDesignFilter']"
          :isChecked="isExpand"
        ...
        <CustomButtonList
          :ParamsRoleId="inputRoleId"
          :ParamsFunctionName="inputFunctionName"
          :BtnFunctionNameArray="['FormTableDesignAdd']"
          @buttonClick="handleButtonClick"
        ></CustomButtonList>
    ...
    <div class="accordion" v-show="isExpand">
      <div ref="accordionRef" class="accordion-content">
        ...
        <CustomButtonList
          :ParamsRoleId="inputRoleId"
          :ParamsFunctionName="inputFunctionName"
          :BtnFunctionNameArray="['FormTableDesignSearch', 'FormTableDesignReset']"
          @buttonClick="handleButtonClick"
        ></CustomButtonList>
    ...
    >
      <template #bodyCell="{ text, column, record }">
        ...
        <template v-if="column.key === 'operation'">
          <a @click="Edit(record)" style="color: #2461a6; margin-right: 10px" v-if="allDyBtn.find((item) => item.functionCode === 'FormTableDesignEdit')"
            >编辑</a
          >
          <a
            @click="handlePreview(record.formDesignId)"
            style="color: rgb(243, 208, 123); margin-right: 10px"
            v-if="allDyBtn.find((item) => item.functionCode === 'FormTableDesignPreviewForm')"
            >预览表单</a
          >
          <a
            @click="handleDownload(record)"
            style="color: rgb(135, 208, 104); margin-right: 10px"
            v-if="allDyBtn.find((item) => item.functionCode === 'FormTableDesignDownload')"
            >代码生成</a
          >
          <a @click="Delete(record.formDesignId)" style="color: rgb(255, 77, 79)" v-if="allDyBtn.find((item) => item.functionCode === 'FormTableDesignDelete')"
            >删除</a
          >
...
const inputFunctionName = ref('FormTableDesign')
...
async function getAllButton() {
  const obj = {
    menuCode: 'FormTableDesign',
    roleids: inputRoleId,
    btnCodes: ['FormTableDesignEdit', 'FormTableDesignDelete', 'FormTableDesignPreviewForm', 'FormTableDesignDownload']
  }
