<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" title="提取变量" class="full-popup">
    <div class="ceri-content-wrapper-search-box pl-10px mt-10px">
    ...
    <BasicTable @register="registerTable" :columns="menuTableColumns" :searchInfo="getSearchInfo">
      <template #tableTitle>
        ...
        <ceri-upload-btn url="/api/system/DataInterfaceVariate/Actions/Import" accept=".ffa" @on-success="reload"></ceri-upload-btn>
      </template>
