...
//获取钉钉配置选择状态
export const getDingSelectState = (obj) => {
  return businessInstance.get('/api/DingTalkMsg/GetSelectState', {
    params: obj
  })
}
//获取企业微信配置选择状态
export const getWeChatSelectState = (obj) => {
  return businessInstance.get('/api/WeChatMsg/GetSelectState', {
    params: obj
  })
}